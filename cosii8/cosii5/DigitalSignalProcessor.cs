...
namespace cosii5
{
    public class DigitalSignalProcessor
    {
        ...
        public void Teach(List<BitmapSource> samples)
        {
            Recognizer = new Recognizer();
            Recognizer.Teach(samples.Select(GetBytes));
        }

        public Vector<double> DetectImages(BitmapSource image)
        {
            return Recognizer.Recognize(GetBytes(image));
        }
